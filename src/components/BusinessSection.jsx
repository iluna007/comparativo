  ...
  return (
    <section id="business" className="section">
      <Reveal direction="left">
        <div className="section-label">10 · Modelos de negocio posibles</div>
        ...
        <p className="section-lead">
          ...
          y servicios a terceros. Dos escenarios según quién sea el propietario del equipo, ambos abiertos a negociación.
        </p>
      </Reveal>

      {businessModels.map((model, i) => (
        <Reveal key={model.num} delay={i * 100} direction={i === 0 ? 'left' : 'right'}>
